...
public sealed record SyncServerOptions(
    ...
    int MaxConnectionAttemptsPerMinute,
    int MaxFanoutConcurrency,
    int MaxBackplaneReceiveQueue,
    ...
    string InstanceId)
{
    public static SyncServerOptions Default { get; } = new(
        ...
        MaxConnectionAttemptsPerMinute: 600,
        MaxFanoutConcurrency: 16,
        MaxBackplaneReceiveQueue: 1024,
    ...
    public static SyncServerOptions FromConfiguration(IConfiguration configuration)
    {
        ...
        return new SyncServerOptions(
            ...
            GetInt(configuration, "MMN_SYNC_MAX_CONNECTION_ATTEMPTS_PER_MINUTE", "Sync:MaxConnectionAttemptsPerMinute", Default.MaxConnectionAttemptsPerMinute, 1, 10_000),
            ...
            GetInt(configuration, "MMN_SYNC_BACKPLANE_RECEIVE_QUEUE", "Sync:MaxBackplaneReceiveQueue", Default.MaxBackplaneReceiveQueue, 1, 100_000),
            ...
            TimeSpan.FromSeconds(GetInt(configuration, "MMN_SYNC_RECEIVE_TIMEOUT_SECONDS", "Sync:ReceiveTimeoutSeconds", (int)Default.ReceiveTimeout.TotalSeconds, 1, 300)),
